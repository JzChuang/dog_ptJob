...
<script type="text/javascript" src="js/getjoblistbytype.js?version=16"></script>
			...
			<div id="sidebar" class="sidebar">
				<div class="mainNavs box-shadow">
					...
					<div id="industry">
						...
						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype0" >所有工作</a><span></span></h2>
							</div>
						</div>
						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype1" >派单</a><span></span></h2>
							</div>
						</div>

						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype2" >促销</a><span></span></h2>
							</div>
						</div>

						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype3" >家教</a><span></span></h2>
							</div>
						</div>

						<div class="menu_box">
							<div class="menu_main">
							<h2><a id="jobtype4" >服务员</a><span></span></h2>
							</div>
						</div>

						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype5" >话务员</a><span></span></h2>
							</div>
						</div>

						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype6" >刷单</a><span></span></h2>
							</div>
						</div>

						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype7"  >销售</a><span></span></h2>
							</div>
						</div>

						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype8"  >营业员</a><span></span></h2>
							</div>
						</div>

						<div class="menu_box">
							<div class="menu_main">
								<h2><a id="jobtype9" href="">其他</a><span></span></h2>
							</div>
						</div>
		...
		<script type="text/javascript">
			...
			/* 查看工作详情 */
				$(document).on("click",".jobTitle",function(){
					...
					/* 投递简历 */
					$(document).on("click",".resumes",function(){
						var userName=$("#userNamelog .out").text();
						
						var tr = $(this).parent().parent();
						var jobId = tr.children("td").eq(0).text();
						if(userName!=""){
							$.post("sendResumes", { jobId: jobId, studentName: userName }, function(data) {
								layer.alert(data);
								});
						}
						else{
							layer.alert("登陆后才可投递简历");
						} 
					})
					...
					$(document).on("click",".collect",function(){
						...
						var jobId = tr.children("td").eq(0).text();
						if(userName!=""){
							$.post("collectjobs", { jobId: jobId, userName: userName }, function(data) {
								layer.alert(data);
								});
						}
						else{
							layer.alert("登陆后才可收藏职位");
						} 
					})
		</script>
	</body>
